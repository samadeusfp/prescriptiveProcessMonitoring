...
out_filename = os.path.join(results_dir, "results_%s_perfectclassifier.csv" % (dataset_name))
with open(out_filename, 'w') as fout:
    ...
    writer.writerow([dataset_name, method, "prec", prec, None, None, None, None, None, conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "rec", rec, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "fscore", fscore, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "tn", tn, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "fp", fp, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "fn", fn, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "tp", tp, None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "earliness_mean", earliness.mean(), None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow([dataset_name, method, "earliness_std", earliness.std(), None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow(
        [dataset_name, method, "earliness_alarms_mean", earliness_alarms.mean(),None, None, None, None, None,  conf_threshold,"1.1"])
    writer.writerow(
        [dataset_name, method, "earliness_alarms_std", earliness_alarms.std(), None, None, None, None, None, conf_threshold,"1.1"])
            ...
            for early_type in ["const", "linear", "nonmonotonic"]:
                ...
                writer.writerow(
                    [dataset_name, method, "cost", cost, c_miss_weight, c_action_weight, c_postpone_weight,
                     c_com_weight, early_type, conf_threshold,"1.1"])
                writer.writerow([dataset_name, method, "cost_avg", cost / len(dt_final), c_miss_weight, c_action_weight,
                                 c_postpone_weight, c_com_weight, early_type, conf_threshold,"1.1"])
